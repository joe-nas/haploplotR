...
devtools::load_all("/path/to/haploplotR")

lead_snps <- read.table("~/../Storage/Documents/Thesis1/section_results/tables/lead_snps.csv", header = T, stringsAsFactors = F)$lead.SNPs[1:2]
