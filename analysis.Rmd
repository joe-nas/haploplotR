...
promoter2200 <- ig_merged_prmoters_gr
...
populations
save(snps_a2,promoter2200, analysis_intervals_a2, populations, file = "data/analysis2.RData")
...
registerDoMC(cores = 14)
ldabase <- LDABase$new(file_path = "/scratch/jfalck/1000G/")
res_analysis2 <- llply(analysis_intervals_a2[c(-13,-36)], function(x){
  dat <- LDAImport$new(ldabase = ldabase, granges =  x, populations = populations)$set_data()
