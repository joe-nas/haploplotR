...
```{r}
p63BS <- with(read.table("/home/Storage/Documents/Thesis1/section_appendix/tables/appendix.p63BS_hg19.bed",
                         stringsAsFactors = F, header = F), GRanges(Rle(V1), IRanges(start = V2, end = V3), ID=V4))
